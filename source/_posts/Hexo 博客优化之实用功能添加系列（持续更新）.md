...
{% fb_img https://starlovei-1257629504.cos.ap-chengdu.myqcloud.com/NEXT/aHR0cHM6Ly9pLmxvbGkubmV0LzIwMTkvMDMvMzAvNWM5ZjkxZWQ4OTczYS5wbmc.jfif %}
注册完毕之后，登录，进入安装页面，选择 City 免费版安装，安装之后你会得到一段代码
{% fb_img https://starlovei-1257629504.cos.ap-chengdu.myqcloud.com/NEXT/20190807103722227.png %}
{% fb_img https://starlovei-1257629504.cos.ap-chengdu.myqcloud.com/NEXT/20190807103745470.png %}
{% fb_img https://starlovei-1257629504.cos.ap-chengdu.myqcloud.com/NEXT/aHR0cHM6Ly9pLmxvbGkubmV0LzIwMTkvMDMvMzEvNWM5ZjkyOWU3ZDYyYi5wbmc.jfif %}
...
{% fb_img https://starlovei-1257629504.cos.ap-chengdu.myqcloud.com/NEXT/aHR0cHM6Ly9pLmxvbGkubmV0LzIwMTkvMDMvMzEvNWM5ZjkyZTNlZWJhYS5wbmc.jfif %}
完成以上操作之后，我们就可以使用来必力评论系统了
{% fb_img https://starlovei-1257629504.cos.ap-chengdu.myqcloud.com/NEXT/20190807103817644.png %}
...
```
效果图：
{% fb_img https://starlovei-1257629504.cos.ap-chengdu.myqcloud.com/NEXT/20191129201331969.png %}
...
{% fb_img https://starlovei-1257629504.cos.ap-chengdu.myqcloud.com/NEXT/aHR0cHM6Ly9pLmxvbGkubmV0LzIwMTkvMDMvMzEvNWM5Zjk1ZmU0ZTM2YS5wbmc.jfif %}
最后在主题目录下的 **_config.yml** 添加以下配置即可
``` css
word_count: true
```
如果显示的位置不好，可以自行更改其位置，成功配置后的效果如下：
{% fb_img https://starlovei-1257629504.cos.ap-chengdu.myqcloud.com/NEXT/20190807104015998.png %}
{% fb_img https://starlovei-1257629504.cos.ap-chengdu.myqcloud.com/NEXT/aHR0cHM6Ly9pLmxvbGkubmV0LzIwMTkvMDMvMzEvNWM5Zjk2ODkyZTRkYi5wbmc.jfif %}
...
```
实现效果如下：
{% fb_img https://starlovei-1257629504.cos.ap-chengdu.myqcloud.com/NEXT/20190807104042630.png %}
## 3 添加网站运营时间
...
```
最后效果如下：
{% fb_img https://starlovei-1257629504.cos.ap-chengdu.myqcloud.com/NEXT/aHR0cHM6Ly9pLmxvbGkubmV0LzIwMTkvMDMvMzEvNWM5Zjk3ZGRlY2E4YS5wbmc.jfif %}
## 4 添加百度统计
...
{% fb_img https://starlovei-1257629504.cos.ap-chengdu.myqcloud.com/NEXT/aHR0cHM6Ly9pLmxvbGkubmV0LzIwMTkvMDMvMzEvNWM5Zjk4NTk0Yzg5NS5wbmc.jfif %}
接着点击代码获取，复制该代码
{% fb_img https://starlovei-1257629504.cos.ap-chengdu.myqcloud.com/NEXT/aHR0cHM6Ly9pLmxvbGkubmV0LzIwMTkvMDMvMzEvNWM5Zjk4ODE1M2MzNS5wbmc.jfif %}
然后到目录 **\themes\hexo-theme-spfk\layout\_partial** 下新建一个 **baidu-analytics.ejs** 文件，里面粘贴你刚刚复制的代码
{% fb_img https://starlovei-1257629504.cos.ap-chengdu.myqcloud.com/NEXT/aHR0cHM6Ly9pLmxvbGkubmV0LzIwMTkvMDMvMzEvNWM5Zjk4YjBiYjRlZi5wbmc.jfif %}
修改主题文件夹下的 **_config.yml** 文件，将你的key（图中涂掉部分）填写进去：
{% fb_img https://starlovei-1257629504.cos.ap-chengdu.myqcloud.com/NEXT/aHR0cHM6Ly9pLmxvbGkubmV0LzIwMTkvMDMvMzEvNWM5Zjk4ZDQzNTQ5ZC5wbmc.jfif %}
所有操作完成后可以在百度统计管理页面检查代码是否安装成功，如果代码安装正确，一般20分钟后，可以查看网站分析数据
{% fb_img https://starlovei-1257629504.cos.ap-chengdu.myqcloud.com/NEXT/aHR0cHM6Ly9pLmxvbGkubmV0LzIwMTkvMDMvMzEvNWM5Zjk5MDBiOWI4Ny5wbmc.jfif %}
...
效果图：
{% fb_img https://starlovei-1257629504.cos.ap-chengdu.myqcloud.com/NEXT/20190807104140857.png %}
