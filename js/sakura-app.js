  ...
  switch (type) {
    case 1:
      if (ele.src.includes('https://cn.gravatar.com/avatar')) {
        ele.src = ele.src.replace('https://cn.gravatar.com/avatar/', 'https://gcore.jsdelivr.net/gh/starlovei/cdn/img/other/gravatar.jpg')
      } else {
        ele.src = 'https://gcore.jsdelivr.net/gh/starlovei/cdn/img/other/default_avatar.jpg'
      }
      break
    case 2:
      ele.src = 'https://gcore.jsdelivr.net/gh/starlovei/cdn/img/other/default_gavatar.jpg'
      break
    case 3:

      ele.src = 'https://gcore.jsdelivr.net/gh/starlovei/cdn/img/other/image-404.png'
      break
    default:
      ele.src = 'https://gcore.jsdelivr.net/gh/starlovei/cdn/img/other/image-404.png'
  }
...
function checkBgImgCookie() {
  ...
  if (bgurl != '') {
    if (bgurl == 'https://gcore.jsdelivr.net/gh/starlovei/cdn/img/themebg/sakura.png' || bgurl == 'https://gcore.jsdelivr.net/gh/starlovei/cdn/img/themebg/plaid.jpg' || bgurl == 'https://gcore.jsdelivr.net/gh/starlovei/cdn/img/themebg/star.png' || bgurl == 'https://gcore.jsdelivr.net/gh/starlovei/cdn/img/themebg/point.png' || bgurl == 'https://gcore.jsdelivr.net/gh/starlovei/cdn/img/themebg/little-monster.png') {
...
$(document).ready(function () {
  ...
  changeBG('#sakura-bg', 'https://gcore.jsdelivr.net/gh/starlovei/cdn/img/themebg/sakura.png')
  changeBG('#gribs-bg', 'https://gcore.jsdelivr.net/gh/starlovei/cdn/img/themebg/plaid.jpg')
  changeBG('#pixiv-bg', 'https://gcore.jsdelivr.net/gh/starlovei/cdn/img/themebg/star.png')
  changeBG('#KAdots-bg', 'https://gcore.jsdelivr.net/gh/starlovei/cdn/img/themebg/point.png')
  changeBG('#totem-bg', 'https://gcore.jsdelivr.net/gh/starlovei/cdn/img/themebg/little-monster.png')
  ...
  $('.skin-menu #dark-bg').click(function () {
    mashiro_global.variables.skinSecter = true
    mashiro_global.variables.isNight = true
    $('body').css('background-image', 'url(https://gcore.jsdelivr.net/gh/starlovei/cdn/img/other/starry_sky.jpg)')
